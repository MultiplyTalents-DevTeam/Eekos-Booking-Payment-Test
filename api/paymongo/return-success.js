...
<head>
  ...
  <title>Payment Received | EEKOS</title>
  <style>
...
<body>
  <main class="shell">
    <section class="card">
      ...
      <p>Your deposit payment was received. EEKOS will finalize reservation confirmation and send updates.</p>
      <div class="actions">
        <a class="primary" href="/payment-success?reference=${encodeURIComponent(safeReference)}">Continue</a>
